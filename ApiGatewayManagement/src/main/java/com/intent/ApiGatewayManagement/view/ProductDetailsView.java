package com.intent.ApiGatewayManagement.view;
...
public class ProductDetailsView {
	...
	public ProductDetailsView(long id, String name, String description, String image, Double price, Integer quantity,
